...
const translate = () => {
    ...
    document.getElementById("lang-links-desktop").classList.remove("show-desk");
}
...
window.addEventListener("load", (event) => {
    ...
    document.getElementById("burger-lang").addEventListener('click', (e) => {
        let target = e.target;
        switch (target.id) {
            case 'esp-mob':
                language = "esp";
    ...
    document.getElementById("drop-lang-btn").addEventListener('click', () => {
        document.getElementById("lang-links-desktop").classList.add("show-desk");
    });
    document.getElementById("lang-links-desktop").addEventListener('click', (e) => {
        let target = e.target;
        switch (target.id) {
            case 'esp-desk':
                language = "esp";
